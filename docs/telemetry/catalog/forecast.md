...
| `nwsl.forecast.model_id` | string | Recommended | development | `["xg-poisson-home-two-seasons-v1"]` | The low-cardinality stable identifier of the primary forecast model selected by an HTTP request. |
| `nwsl.forecast.model_ids` | string[] | Recommended | development | `[["results-poisson-home-two-seasons-v1","xg-poisson-home-two-seasons-v1"]]` | Low-cardinality stable identifiers of all forecast models calculated by an operation. |
...
| `nwsl.forecast.model_ids` | string[] | Required | development | Low-cardinality stable identifiers of all forecast models calculated by an operation. |
